...
2. [Create a GitHub Personal Access Token](https://github.com/settings/personal-access-tokens/new).
   ...
   ### Code Scanning Tools
   - **GetCodeScanningAlert**, **ListCodeScanningAlerts** - Access code scanning alerts
     - Required permissions: `security_events` (for private repos) or no permissions (for public repos)
